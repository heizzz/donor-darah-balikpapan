...
@section('content')
<div class="container">
    <form method="POST" action="{{ route('register') }}" class="col-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
        @csrf
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <select type="gender" name="gender" id="gender" class="form-control">
                    ...
                    <option value="m" @if (old('gender') == 'm') selected @endif >Laki-laki (Male)</option>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <input type="date" id="tanggal_lahir" class="form-control @error('date') is-invalid @enderror" name="tanggal_lahir" class="form-control">
